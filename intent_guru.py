...
class IntentGuruAgent:
    def __init__(self):
        with open(os.path.join(os.path.dirname(__file__), 'prompts', 'intent_guru.yaml'), encoding='utf-8') as f:
    ...
    async def run(self, query: str):
        ...
        user_prompt = self.prompt['user'].replace('{query}', query)
